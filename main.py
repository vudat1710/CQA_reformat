...
def parse():
    ...
    parser.add_argument('-pr', '--pretrained_path', default='vectors_pruned.200.txt', help='Pretrained word embedding used in training')
    parser.add_argument('-nd', '--num_dimensions', type=int, default=300, help='Number of word embedding dimensions')
    parser.add_argument('-b', '--batch_size', type=int, default=160, help='Batch size')
    parser.add_argument('-p', '--pad', type=int, default=50, help='Padding len in vectorizer')
    ...
    parser.add_argument('-ub', '--use_bi', default=False, help='Use Bidirectional LSTM or not')
    ...
    parser.add_argument('-up', '--use_pool', default=False, type=bool, help='Use max pooling in lstm model')
    parser.add_argument('-uw', '--use_w2v', default=False, type=bool, help='Use word2vec to gain extra information for word embedding')
